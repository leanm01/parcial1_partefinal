...
/*int buscarRecaudContLibre(eRecaudacion arrayRecaudacion[],int tamArrayRecaudacion,int idContribuyente)
{
    ...
    {
        if(arrayRecaudacion[i].idContribuyente == idContribuyente)
        {
            retorno = i;
        }
    }
    ...
    if (tamArrayRecaudacion >0)
    {
        for (i=0; i<tamArrayRecaudacion; i++)
        {
            ...
            if(espacioLibre>=0)
            {
                ...
                utn_getInt("\nIngrese el mes: ","\nIngresa un valor correcto 0-12: ",&arrayRecaudacion[espacioLibre].mes,2,12,0);
...
int modificacionRecaudacion(eRecaudacion arrayRecaudacion[], int tamArrayRecaudacion)
{
    ...
    utn_getInt("\nIngrese el --ID RECAUDACION-- que quiera modificar: ","\nIngresa un valor correcto 0-199: ",&aux,2,1999,0);
...
int cantidadRecaudaciones(eRecaudacion arrayRecaudacion[], int tamArrayRecaudacion)
{
    ...
    for(i=0;i<tamArrayRecaudacion;i++)
    {
        ...
        if(strcpy(arrayRecaudacion[i].estado, "SALDADO") == 0)
        {
     ...
     printf("La cantidad de saldadas mayores a 1000 son: %d", contadorImporte);
     return 1;
}
/*int contriRecau(eRecaudacion arrayRecaudacion[], int tamArrayRecaudacion)
{
