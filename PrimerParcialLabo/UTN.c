...
int menu()
{
   ...
   // printf("                ABM                      \n\n");
	...
	printf("8) INFORMES\n");
    printf("9) SALIR\n");
    utn_getInt("\nIngrese opcion: ", "Ingrese una opcion entre 1 y 8", &opcion, 3, 9, 1);
...
int informes()
{
    ...
    printf("3-Informar todos los datos de los contribuyentes de un tipo de recaudación\n");
    printf("4-Nombre y c.u.i.l. de los Contribuyentes que pagaron impuestos en febrero\n");
    printf("5-Salir\n");
